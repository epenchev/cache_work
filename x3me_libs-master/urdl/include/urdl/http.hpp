...
class bind_point
{
    boost::asio::ip::tcp::endpoint value_;

public:
    bind_point() = default;

    explicit bind_point(const boost::asio::ip::tcp::endpoint& v) : value_(v) {}

    const boost::asio::ip::tcp::endpoint& value() const { return value_; }

    void value(const boost::asio::ip::tcp::endpoint& v) { value_ = v; }
};
...
public:
     ...
     */
    explicit request_method(const std::string& v) : value_(v) {}
...
public:
     ...
     * Postcondition: <tt>value() == v</tt>
     */
    explicit request_content(const std::string& v) : value_(v) {}
...
public:
     ...
     * Postcondition: <tt>value() == v</tt>
     */
    explicit request_content_type(const std::string& v) : value_(v) {}
...
public:
    ...
    /**
     * @par Remarks
     * Postcondition: <tt>value() ==
     * std::numeric_limits<std::size_t>::max()</tt>.
     */
    max_redirects() : value_(~std::size_t(0)) {}
     ...
     * Postcondition: <tt>value() == v</tt>
     */
    explicit max_redirects(std::size_t v) : value_(v) {}
     ...
     * Postcondition: <tt>value() == v</tt>
     */
    void value(std::size_t v) { value_ = v; }
...
public:
     ...
     * Postcondition: <tt>value() == v</tt>
     */
    explicit user_agent(const std::string& v) : value_(v) {}
